...
from abide import __version_info__, __version__
...
def main(version):
    ...
    print('Updating abide/__init__.py ... ', end="")
    with open('abide/__init__.py', 'w') as init_file:
    ...
    os.system('open "https://pypi.python.org/pypi?:action=pkg_edit&name=abide"')
