...
cover:
	. venv/bin/activate; \
  find tests -type d | xargs nosetests --with-coverage --cover-inclusive --cover-erase --cover-package=abide

docs-install:
	. venv/bin/activate; pip install pdoc

docs:
	. venv/bin/activate; pdoc abide --overwrite --html --html-dir docs
